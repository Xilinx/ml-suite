...
Overlays are compatible with specific hardware platforms. AWS overlays are included directly in the github repository, however other platform overlays must be downloaded from [xilinx](https://www.xilinx.com/products/acceleration-solutions/xilinx-machine-learning-suite.html) and unzipped within this directory:  
