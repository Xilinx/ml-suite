...
#./run.sh -p $PLATFORM -t test_detect -m yolo_v2_608 -k v3 -b 8 -g /wrk/acceleration/shareData/COCO_Dataset/labels/val2014
#cp single_img_out.txt $NW_LOG_DIR/
#cp batch_out.txt $NW_LOG_DIR/
#cd -
#
#printf "\n\n" >> nw_status.txt
#
...
#grep "exec_dnn" $NW_LOG_DIR/single_img_out.txt | tail -1 >> nw_status.txt
#
