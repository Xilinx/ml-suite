...
for BITWIDTH in 8; do
    for DSP_WIDTH in 56; do
        python $MLSUITE_ROOT/examples/deployment_modes/mp_classify.py \
            ...
            --labels $MLSUITE_ROOT/models/data/places365/synset_words.txt \
            --xlnxlib $LIBXDNN_PATH \
            --images $MLSUITE_ROOT/models/data/places365/places365_img_val \
            --golden $MLSUITE_ROOT/models/data/places365/val.txt \
