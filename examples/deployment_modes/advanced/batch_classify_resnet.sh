...
for BITWIDTH in 8; do
    for DSP_WIDTH in 56; do
        python $MLSUITE_ROOT/examples/deployment_modes/mp_classify.py \
            --xclbin $XCLBIN_PATH/xdnn_v2_32x${DSP_WIDTH}_$((112 / ${DSP_WIDTH}))pe_${BITWIDTH}b_$((2 + ${DSP_WIDTH} / 14))mb_bank21.xclbin \
            --netcfg $MLSUITE_ROOT/examples/compile/work/caffe/resnet/fp32/resnet50_without_bn_deploy_${DSP_WIDTH}.cmds.json \
            --fpgaoutsz 2048 \
            --datadir /wrk/acceleration/MLsuite/master/models/caffe/resnet/int8/resnet50_without_bn.caffemodel_data \
            ...
            --quantizecfg /wrk/acceleration/MLsuite/master/models/caffe/resnet/int8/resnet50_without_bn_quantized_int${BITWIDTH}_deploy.json \
